...
///         the file, EOF.
int _CDECL sbtopc(srcbuf_t *const sb);
/// @brief Gets the top character from the source
...
///         case of failure or if reached the end of
///         the file, EOF.
int _CDECL sbgetc(srcbuf_t *const sb);
...
///         case of failure or if reached the end of
///         the file, EOF.
int _CDECL sbsetc(srcbuf_t *const sb, int c);
/// @brief Sets the top character of the source buffer
...
///         case of failure or if reached the end of
///         the file, EOF.
int _CDECL sbputc(srcbuf_t *const sb, int c);
...
char *_CDECL sbtops(char *const dst, srcbuf_t *const sb, unsigned int count);
/// @brief Reads a string from the source buffer in the
...
/// @param count Maximum number of characters to read.
/// @return A pointer to the destination buffer.
char *_CDECL sbgets(char *const dst, srcbuf_t *const sb, unsigned int count);
...
///         of error.
char *_CDECL sbsets(srcbuf_t *const sb, char *const src, unsigned int count);
/// @brief Writes a string from the source buffer in the
...
/// @return A pointer to the source string or NULL in case
///         of error.
char *_CDECL sbputs(srcbuf_t *const sb, char *const src, unsigned int count);
...
///         chopped content.
char *_CDECL sbchop(srcbuf_t *const sb);
/// @brief Chops buffer content from begin postion to
...
/// @param sb Pointer to the source buffer reader.
/// @return A pointer to the destination buffer.
char *_CDECL sbchto(char *const dst, srcbuf_t *const sb);
...
/// @return A pointer to the destination buffer.
char *_CDECL sbchof(char *const dst, srcbuf_t *const sb, unsigned int count);

/// @brief Gets the beginning of the internal source
///        buffer.
/// @param sb Pointer to the source buffer reader.
/// @return A pointer to the source buffer.
char *_CDECL sbgetbuf(srcbuf_t *const sb);
...
/// @param sb Pointer to the source buffer reader.
void _CDECL sbadvnc(srcbuf_t *const sb);
/// @brief Retreats position counter to zero.
/// @param sb Pointer to the source buffer reader.
void _CDECL sbretrt(srcbuf_t *const sb);
/// @brief Resets position counters to zero and
///        resets buffer to the beginning.
/// @param sb Pointer to the source buffer reader.
void _CDECL sbrewnd(srcbuf_t *const sb);
...
tokcode_t _CDECL getkword(char *const lexeme, unsigned int context);
/// @brief Gets the corresponding token code to the
...
tokcode_t _CDECL getpragm(char *const lexeme);
...
tokcode_t _CDECL gettoken(srcbuf_t *const sb, char **const lexeme);
